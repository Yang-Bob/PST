...
def get_arguments():
    ...
    parser.add_argument("--arch", type=str,default='FPST') #
    parser.add_argument("--max_steps", type=int, default=200001) # 100001
...
def train(args):
    ...
    for data in train_loader:
        ...
        loss_val, loss_part1, loss_part2 = model.get_loss(logits, query_mask, support_mask)
